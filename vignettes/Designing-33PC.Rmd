...
The *precautionary coherence* (PC) principle introduced in [@norris_precautionary_2017] requires that "a PC trial conducts escalation only through titration." Please see that paper or [this lay explainer](https://www.patreon.com/posts/21021190) for a fuller discussion. To appreciate the ethical content of the PC principle in an especially vivid way, you might try imagining yourself in the trialist's place in [this scenario](https://www.patreon.com/posts/21599895).
